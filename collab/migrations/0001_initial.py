    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_creator', models.BooleanField(default=False, help_text='Użytkownik, który utworzył pokój', verbose_name='Twórca')),
                ('profile_image', models.ImageField(default='profile_images/default.png', upload_to='profile_images', verbose_name='Zdjęcie profilowe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_room_name', models.CharField(default='NwJJPVCw4Mr4lzD6p', max_length=24)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(default='', editable=False, max_length=10, unique=True)),
                ('category', models.CharField(choices=[('podstawowy', 'podstawowy'), ('średnio-zaawansowany', 'średnio-zaawansowany'), ('zaawansowany', 'zaawansowany')], default='podstawowa', max_length=50)),
                ('boards', models.ManyToManyField(blank=True, related_name='boards', to='collab.excalidrawroom')),
                ...
                ('users', models.ManyToManyField(blank=True, related_name='users_group', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Pseudonym',
